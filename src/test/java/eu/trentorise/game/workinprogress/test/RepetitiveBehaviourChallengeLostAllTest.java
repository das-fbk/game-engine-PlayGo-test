...
public class RepetitiveBehaviourChallengeLostAllTest extends GameTest{
	...
	public void initEnv() {
		...
		data.put("bonusPointType", "green leaves");
		cc = playerSrv.assignChallenge(GAME, PLAYER, "repetitiveBehaviour", "repetitiveBehaviourInstance",
					data, dayBeforeYesterdayDate, tomorrowDate);
